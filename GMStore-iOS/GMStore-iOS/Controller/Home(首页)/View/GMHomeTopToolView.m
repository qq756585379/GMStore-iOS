...
@property (weak ,nonatomic) id dcObserve2;
@end

@implementation GMHomeTopToolView
...
- (void)acceptanceNote{
    ...
    _dcObserve2 = [[NSNotificationCenter defaultCenter] addObserverForName:HIDETOPTOOLVIEW object:nil queue:[NSOperationQueue mainQueue] usingBlock:^(NSNotification * _Nonnull note) {
...
- (void)dealloc{
    ...
    [[NSNotificationCenter defaultCenter] removeObserver:_dcObserve2];
}
