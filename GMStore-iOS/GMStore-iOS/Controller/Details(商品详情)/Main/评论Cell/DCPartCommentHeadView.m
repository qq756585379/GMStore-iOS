...
- (void)setUpTextComment
{
    ...
    UIImage *image = ([userInfo.userimage isEqualToString:@"icon"]) ? [[UIImage imageNamed:@"icon"] yj_circleImage] : [[YJTool Base64StrToUIImage:userInfo.userimage] yj_circleImage];
    ...
    _nickNameLabel.text = [YJTool yj_encryptionDisplayMessageWith:userInfo.nickname WithFirstIndex:2];
