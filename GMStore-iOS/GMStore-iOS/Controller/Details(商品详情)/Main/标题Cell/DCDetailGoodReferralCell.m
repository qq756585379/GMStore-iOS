...
- (void)setUpUI
{
    ...
    [YJTool yj_setUpAcrossPartingLineWith:self WithColor:[[UIColor lightGrayColor]colorWithAlphaComponent:0.15]];
}
...
- (void)layoutSubviews
{
    ...
    [YJTool yj_setUpLongLineWith:_goodTitleLabel WithColor:[[UIColor lightGrayColor]colorWithAlphaComponent:0.15] WithHightRatio:0.6];
}
