...
- (void)setUpNav
{
    self.navigationItem.rightBarButtonItem = [UIBarButtonItem itemWithImage:[UIImage imageNamed:@"Details_Btn_More_normal"] highImage:[UIImage imageNamed:@"Details_Btn_More_normal"] target:self action:@selector(toolItemClick)];
}
...
- (void)toolItemClick
{
    [self setUpAlterViewControllerWith:[DCToolsViewController new] WithDistance:150
                         WithDirection:XWDrawerAnimatorDirectionTop WithParallaxEnable:NO WithFlipEnable:NO];
}
