...
- (void)setUpUI
{
    ...
    _collectButton.frame = CGRectMake(self.width - 80, 0, 80, self.height * 0.5);
    ...
    _addShopCarButton.frame = CGRectMake(self.width - 80,self.height * 0.5, 80, self.height * 0.5);
    ...
    CGFloat buttonX = (self.width - _addShopCarButton.width) / 2;
    CGFloat buttonW = 50;
    CGFloat buttonH = self.height * 0.5;
