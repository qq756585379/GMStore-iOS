...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    DCAttributeItemCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:[DCAttributeItemCell cellReuseIdentifier]
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([kind  isEqualToString:UICollectionElementKindSectionHeader]) {
        ...
        DCHeaderReusableView *headerView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:[DCHeaderReusableView reuseIdentifier] forIndexPath:indexPath];
        WEAK_SELF
        ...
        DCFooterReusableView *footerView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:[DCFooterReusableView reuseIdentifier] forIndexPath:indexPath];
        return footerView;
    }
}
#pragma mark - <UICollectionViewDelegate>
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout referenceSizeForFooterInSection:(NSInteger)section {
    return CGSizeMake(self.collectionView.width, DCMargin);
}
...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        _collectionView.frame = CGRectMake(5, DCMargin, FiltrateViewScreenW - DCMargin, SCREEN_HEIGHT - 60);
        _collectionView.showsVerticalScrollIndicator = NO;
        
        [_collectionView registerClass:[DCAttributeItemCell class] forCellWithReuseIdentifier:[DCAttributeItemCell cellReuseIdentifier]];
        
        [_collectionView registerNib:[UINib nibWithNibName:@"DCHeaderReusableView" bundle:nil]
          forSupplementaryViewOfKind:UICollectionElementKindSectionHeader
                 withReuseIdentifier:@"DCHeaderReusableView"]; //头部
        [_collectionView registerClass:[DCFooterReusableView class] forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:[DCFooterReusableView reuseIdentifier]]; //尾部
    }
