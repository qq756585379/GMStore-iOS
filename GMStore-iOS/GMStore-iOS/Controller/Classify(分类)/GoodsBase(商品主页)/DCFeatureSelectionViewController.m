...
@interface DCFeatureSelectionViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,
HorizontalCollectionLayoutDelegate,PPNumberButtonDelegate,UITableViewDelegate,UITableViewDataSource>
...
- (void)setUpBase
{
    ...
    self.collectionView.frame = CGRectMake(0, self.tableView.bottom ,SCREEN_WIDTH , NowScreenH - 200);
