...
-(void)setYouSelectItem:(GMRecommendItem *)youSelectItem
{
    ...
    //首行缩进
    [YJTool yj_setUpLabel:_gridLabel content:youSelectItem.main_title indentationFortheFirstLineWith:_gridLabel.font.pointSize * 2.5];
}
