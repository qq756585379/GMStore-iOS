...
{
    DCGroupImageCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:[DCGroupImageCell cellReuseIdentifier]
...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[DCGroupImageCell class] forCellWithReuseIdentifier:[DCGroupImageCell cellReuseIdentifier]];
