...
{
    _topToolView = [[DCBeautyTopToolView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 64)];
...
{
    return CGSizeMake(SCREEN_WIDTH, DCMargin);
}
...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        _collectionView.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT - TAB_BAR_HEIGHT);
